...
SRC_ROOT=`abspath ${SCRIPT_ROOT}/../GVCUIKit`
OUT_ROOT=$TMPDIR/GVCUIKit
...
echo "load documentation set with path \"/Users/$USER/Library/Developer/Shared/Documentation/DocSets/net.global-village.GVCUIKit.docset\""
